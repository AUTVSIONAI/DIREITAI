...
async function run() {
    console.log('--- Testing Mapbox Proximity & Queries ---');
    
    // SP Center approx: -46.633308, -23.550520
    const spProximity = '-46.633308,-23.550520';

    const queries = [
        { q: "Museu de Arte de São Paulo", opts: { proximity: spProximity } }, // No types
        { q: "MASP", opts: { proximity: spProximity } },
        { q: "Av Paulista 1578", opts: { proximity: spProximity } }
    ];
